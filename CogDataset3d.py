...
class CogDataset3d(torch.utils.data.Dataset):
    ...
    def __init__(self, input_dir, target_dir, input_files, df, transform=False, crop = (128,128,128)):
        ...
        patient_files = pickle.load(open( "../brainlabs_prep/data/patient_files.data", "rb" ))
...
def initialize_data():
    input_path = '../brainlabs_prep/data/input_files/'
    target_path = '../brainlabs_prep/data/target_files/'
...
def get_file_splits(subset='all'):
    ...
    if subset == 'all':
        paths = ['../brainlabs_prep/data/fnames_split/train_files5.data', 
                 '../brainlabs_prep/data/fnames_split/val_files5.data'] 
